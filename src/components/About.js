        ...
        <React.Fragment>
            ...
            <div className="mx-5 mt-24 sm:mx-16 lg:flex">
                <div className="flex flex-col justify-between pl-5 pr-5 sm:pr-20 lg:w-4/5 xl:w-3/5">
                    ...
                    <p className="mb-10 font-montserratRegular">RECCA is a video recording tool that helps you get your message across through instantly shareable videos.
                    With RECCA, you can record your camera, microphone, and desktop simultaneously. Your video is then instantly available to share through cloud technology. </p>
                    <div className="text-center font-montserratRegular">
                        <p className="mb-2">
                            Questions, comments, concerns? Contact us{" "}
                            <span className="text-blue-600 cursor-pointer hover:underline" onClick={() => history.push("/contact")}>here</span>

        ...
        <>
            ...
            <div className="mx-5 mt-24 sm:mx-16 lg:flex">
                <div className="flex flex-col justify-between pl-5 pr-5 sm:pr-20 lg:w-4/5 xl:w-3/5">
                    <p className="mb-5 text-xl font-semibold font-montserratMedium">Welcome! We're so glad you're here.<span role="img">💖</span></p>
                    ...
                    <div className="text-center font-montserratRegular">
                        <p className="mb-2">Questions, comments, concerns? Contact us <span className="text-blue-600 cursor-pointer hover:underline" onClick={() => history.push("/contact")}>here</span> <span role="img">👈</span></p>
                        <p>Happy recording! <span role="img">🎥</span> <span role="img">😄</span></p>
                    </div>
                </div>
            ...
            <div className="py-5 mt-16 border-t lg:mt-24 footer">
